# UCT 3rd Year Project: ATLAS Open Data – Top Quark Pair Search

This repository contains a Jupyter Notebook for a UCT 3rd Year Physics Project, where students analyse real ATLAS Open Data to search for evidence of top quarks, specifically, top quark pairs.
...
The project requires input data files that can be downloaded from the following link: [Data Files](https://uctcloud-my.sharepoint.com/:f:/r/personal/01452979_wf_uct_ac_za/Documents/PHY3%20Projects/top_quark_pairs_search?csf=1&web=1&e=d76oeL).
